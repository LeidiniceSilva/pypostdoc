...
class CordexDataset(Dataset):
    ...
    def __init__(self, output_file_path, regcm_file, simulation):
        ...
        newattr = {
            ...
            'note': 'The domain ' + simulation.domain + ' is smaller than the EUR-11 domain',
            ...
            'driving_experiment':'evaluation run with reanalysis forcing',
            ...
            'grid': 'Rotated-pole latitude-longitude with 3km grid spacing',
