...
if freq == 'hourly':
	...
	plt_map = map.contourf(xx, yy, mbe_regcm_era5_djf[0][0], levels=levs, cmap=cm.BrBG, extend='both') 
	plt.title(u'(a) RegCM5 - ERA5 DJF', loc='left', fontsize=font_size, fontweight='bold')

	ax = fig.add_subplot(4, 1, 2)  
	map, xx, yy = basemap(lat, lon)
	plt_map = map.contourf(xx, yy, mbe_regcm_era5_mam[0][0], levels=levs, cmap=cm.BrBG, extend='both') 
	plt.title(u'(b) RegCM5 - ERA5 MAM', loc='left', fontsize=font_size, fontweight='bold')

	ax = fig.add_subplot(4, 1, 3)  
	map, xx, yy = basemap(lat, lon)
	plt_map = map.contourf(xx, yy, mbe_regcm_era5_jja[0][0], levels=levs, cmap=cm.BrBG, extend='both') 
	plt.title(u'(c) RegCM5 - ERA5 JJA', loc='left', fontsize=font_size, fontweight='bold')

	ax = fig.add_subplot(4, 1, 4)  
	map, xx, yy = basemap(lat, lon)
	plt_map = map.contourf(xx, yy, mbe_regcm_era5_son[0][0], levels=levs, cmap=cm.BrBG, extend='both') 
	...
	ax = fig.add_subplot(4, 1, 1)  
	map, xx, yy = basemap(lat, lon)
	plt_map = map.contourf(xx, yy, mbe_regcm_cpc_djf[0][0], levels=levs, cmap=cm.BrBG, extend='both') 
	plt.title(u'(a) RegCM5 - CPC DJF', loc='left', fontsize=font_size, fontweight='bold')

	ax = fig.add_subplot(4, 1, 2)  
	map, xx, yy = basemap(lat, lon)
	plt_map = map.contourf(xx, yy, mbe_regcm_cpc_mam[0][0], levels=levs, cmap=cm.BrBG, extend='both') 
	plt.title(u'(b) RegCM5 - CPC MAM', loc='left', fontsize=font_size, fontweight='bold')

	ax = fig.add_subplot(4, 1, 3)  
	map, xx, yy = basemap(lat, lon)
	plt_map = map.contourf(xx, yy, mbe_regcm_cpc_jja[0][0], levels=levs, cmap=cm.BrBG, extend='both') 
	plt.title(u'(c) RegCM5 - CPC JJA', loc='left', fontsize=font_size, fontweight='bold')

	ax = fig.add_subplot(4, 1, 4)  
	map, xx, yy = basemap(lat, lon)
	plt_map = map.contourf(xx, yy, mbe_regcm_cpc_son[0][0], levels=levs, cmap=cm.BrBG, extend='both') 
