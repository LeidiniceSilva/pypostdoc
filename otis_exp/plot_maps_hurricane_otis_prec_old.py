...
def plot_precipitation_timeseries_comparison(
    ...
    data_model = "/leonardo/home/userexternal/mdasilva/leonardo_work/Otis_exp/exps_mp_regrided/"
    data_era5 = ds_dict['ERA5'][precip_var]
    data_cmorph = ds_dict['CMORPH'][precip_var]
...
# %%
#station = pd.read_csv("/leonardo/home/userexternal/mdasilva/leonardo_work/Otis_exp/ws/Estacion_ACAPULCO_SEMAR_24_horas.csv")
...
# read file (skip metadata lines)
station = pd.read_csv(
    "/leonardo/home/userexternal/mdasilva/leonardo_work/Otis_exp/ws/Estacion_ACAPULCO_SEMAR_24_horas.csv",
    encoding="latin1",
    skiprows=8
)
...
# select correct columns (note the proper accent)
station = station[["Fecha UTC", "Precipitación (mm)"]] \
    .rename(columns={"Fecha UTC": "time", "Precipitación (mm)": "pr"})
...
# hourly accumulated precipitation (mm/h as accumulation)
station = station.resample("1h").sum()

print(station)

# %%
experiments = ["noto", "wsm5", "wsm7", "wdm7", "ERA5", "CMORPH"]
data_dir = "/leonardo/home/userexternal/mdasilva/leonardo_work/Otis_exp/exps_mp_regrided/"
ds_models = {}

for exp in experiments:
    if exp == "ERA5":
        ds_models[exp] = xr.open_dataset("/leonardo/home/userexternal/mdasilva/leonardo_work/Otis_exp/era5/1hr/tp_ERA5_Otis_1hr_Oct2023.nc")
        ...
        ds_models[exp] = xr.open_dataset(
            "/leonardo/home/userexternal/mdasilva/leonardo_work/Otis_exp/cmorph/CMORPH_cut_domain_20251022_20251025.nc"
        )
...
model_experiments = ["noto", "wsm5", "wsm7", "wdm7"]
...
for model_exp in model_experiments:
    ...
    plt.savefig(OUTPUT_PATH + f"pyplt_Hurricane_Otis_prec.png",
