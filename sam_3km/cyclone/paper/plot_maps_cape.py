...
ct1 = ax1.contour(lon, lat, cape_era5_i, colors='black', linewidths=0.50)
...
ct2 = ax2.contour(lon, lat, cape_regcm5_i, colors='black', linewidths=0.50)
...
ct3 = ax3.contour(lon, lat, cape_wrf415_i, colors='black', linewidths=0.50)
...
ct4 = ax4.contour(lon, lat, cape_era5_ii, colors='black', linewidths=0.50)
...
ct5 = ax5.contour(lon, lat, cape_regcm5_ii, colors='black', linewidths=0.50)
...
ct6 = ax6.contour(lon, lat, cape_wrf415_ii, colors='black', linewidths=0.50)
...
ct7 = ax7.contour(lon, lat, cape_era5_iii, colors='black', linewidths=0.50)
...
ct8 = ax8.contour(lon, lat, cape_regcm5_iii, colors='black', linewidths=0.50)
...
ct9 = ax9.contour(lon, lat, cape_wrf415_iii, colors='black', linewidths=0.50)
