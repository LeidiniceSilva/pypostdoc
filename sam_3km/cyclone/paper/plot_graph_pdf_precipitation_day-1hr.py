...
p99_inmet_hr = np.nanpercentile(pr_inmet_hr, 99.9)
p99_gpm_hr = np.nanpercentile(pr_gpm_hr, 99.9)
p99_era5_hr = np.nanpercentile(pr_era5_hr, 99.9)
p99_regcm5_hr = np.nanpercentile(pr_regcm5_hr, 99.9)
p99_wrf415_hr = np.nanpercentile(pr_wrf415_hr, 99.9)

p99_inmet_day = np.nanpercentile(pr_inmet_day, 99.9)
p99_gpm_day = np.nanpercentile(pr_gpm_day, 99.9)
p99_era5_day = np.nanpercentile(pr_era5_day, 99.9)
p99_regcm5_day = np.nanpercentile(pr_regcm5_day, 99.9)
p99_wrf415_day = np.nanpercentile(pr_wrf415_day, 99.9)
...
ax1.set_yscale('log')
ax1.legend(loc=1, ncol=1, fontsize=font_size, shadow=True)
