...
round_inmet_c_ii_iii_iv = np.round(inmet_c_ii_iii_iv,0)
round_cpc_c_ii_iii_iv   = np.round(cpc_c_ii_iii_iv,0)
round_era5_c_ii_iii_iv  = np.round(era5_c_ii_iii_iv,0)
round_regcm_c_ii_iii_iv = np.round(regcm5_c_ii_iii_iv,0)

round_inmet_c_v = np.round(inmet_c_v,0)
round_cpc_c_v   = np.round(cpc_c_v,0)
round_era5_c_v  = np.round(era5_c_v,0)
round_regcm_c_v = np.round(regcm5_c_v,0)

round_inmet_c_vi = np.round(inmet_c_vi,0)
round_cpc_c_vi   = np.round(cpc_c_vi,0)
round_era5_c_vi  = np.round(era5_c_vi,0)
round_regcm_c_vi = np.round(regcm5_c_vi,0)

# Filter 0 mm/day
filter_inmet_c_i = round_inmet_c_i[round_inmet_c_i > 0.]
filter_cpc_c_i   = round_era5_c_i[round_cpc_c_i > 0.]
filter_era5_c_i  = round_era5_c_i[round_era5_c_i > 0.]
filter_regcm_c_i = round_regcm_c_i[round_regcm_c_i > 0.]

filter_inmet_c_ii_iii_iv = round_inmet_c_i[round_inmet_c_ii_iii_iv > 0.]
filter_cpc_c_ii_iii_iv   = round_era5_c_i[round_cpc_c_ii_iii_iv > 0.]
filter_era5_c_ii_iii_iv  = round_era5_c_i[round_era5_c_ii_iii_iv > 0.]
filter_regcm_c_ii_iii_iv = round_regcm_c_i[round_regcm_c_ii_iii_iv > 0.]

filter_inmet_c_v = round_inmet_c_i[round_inmet_c_v > 0.]
filter_cpc_c_v   = round_era5_c_i[round_cpc_c_v > 0.]
filter_era5_c_v  = round_era5_c_i[round_era5_c_v > 0.]
filter_regcm_c_v = round_regcm_c_i[round_regcm_c_v > 0.]

filter_inmet_c_vi = round_inmet_c_i[round_inmet_c_vi > 0.]
filter_cpc_c_vi   = round_era5_c_i[round_cpc_c_vi > 0.]
filter_era5_c_vi  = round_era5_c_i[round_era5_c_vi > 0.]
filter_regcm_c_vi = round_regcm_c_i[round_regcm_c_vi > 0.]
...
x_pdf_inmet_c_ii_iii_iv, pdf_inmet_c_ii_iii_iv = np.unique(filter_inmet_c_ii_iii_iv, return_counts=True) 
x_pdf_era5_c_ii_iii_iv,  pdf_era5_c_ii_iii_iv  = np.unique(filter_era5_c_ii_iii_iv,  return_counts=True) 
x_pdf_regcm_c_ii_iii_iv, pdf_regcm_c_ii_iii_iv = np.unique(filter_regcm_c_ii_iii_iv, return_counts=True) 
...
x_pdf_inmet_c_vi, pdf_inmet_c_vi = np.unique(filter_inmet_c_v, return_counts=True) 
x_pdf_cpc_c_vi,   pdf_cpc_c_vi   = np.unique(filter_cpc_c_v,   return_counts=True) 
x_pdf_era5_c_vi,  pdf_era5_c_vi  = np.unique(filter_era5_c_v,  return_counts=True) 
x_pdf_regcm_c_vi, pdf_regcm_c_vi = np.unique(filter_regcm_c_v, return_counts=True)
