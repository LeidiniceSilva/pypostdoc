...
lat, lon, ua_era5_djf = import_grid('u', domain, 'ERA5', 'DJF')
lat, lon, ua_era5_mam = import_grid('u', domain, 'ERA5', 'MAM')
lat, lon, ua_era5_jja = import_grid('u', domain, 'ERA5', 'JJA')
lat, lon, ua_era5_son = import_grid('u', domain, 'ERA5', 'SON')
lat, lon, ua_regcm_djf = import_grid('ua', domain, 'RegCM5', 'DJF')
lat, lon, ua_regcm_mam = import_grid('ua', domain, 'RegCM5', 'MAM')
lat, lon, ua_regcm_jja = import_grid('ua', domain, 'RegCM5', 'JJA')
lat, lon, ua_regcm_son = import_grid('ua', domain, 'RegCM5', 'SON')
mbe_djf_regcm_era5_ua = compute_mbe(regcm_djf, era5_djf)
mbe_mam_regcm_era5_ua = compute_mbe(regcm_mam, era5_mam)
mbe_jja_regcm_era5_ua = compute_mbe(regcm_jja, era5_jja)
mbe_son_regcm_era5_ua = compute_mbe(regcm_son, era5_son)	
		
lat, lon, va_era5_djf = import_grid('v', domain, 'ERA5', 'DJF')
lat, lon, va_era5_mam = import_grid('v', domain, 'ERA5', 'MAM')
lat, lon, va_era5_jja = import_grid('v', domain, 'ERA5', 'JJA')
lat, lon, va_era5_son = import_grid('v', domain, 'ERA5', 'SON')
lat, lon, va_regcm_djf = import_grid('va', domain, 'RegCM5', 'DJF')
lat, lon, va_regcm_mam = import_grid('va', domain, 'RegCM5', 'MAM')
lat, lon, va_regcm_jja = import_grid('va', domain, 'RegCM5', 'JJA')
lat, lon, va_regcm_son = import_grid('va', domain, 'RegCM5', 'SON')
mbe_djf_regcm_era5_va = compute_mbe(regcm_djf, era5_djf)
mbe_mam_regcm_era5_va = compute_mbe(regcm_mam, era5_mam)
mbe_jja_regcm_era5_va = compute_mbe(regcm_jja, era5_jja)
mbe_son_regcm_era5_va = compute_mbe(regcm_son, era5_son)	
	
elif var == 'tasmax':
	dict_var = {'tasmax': ['tmx', 'tmax', 'mx2t']}
	
	lat_djf, lon_djf, cru_djf = import_grid(dict_var[var][1], domain, 'CRU', 'DJF')
	lat_mam, lon_mam, cru_mam = import_grid(dict_var[var][1], domain, 'CRU', 'MAM')
	lat_jja, lon_jja, cru_jja = import_grid(dict_var[var][1], domain, 'CRU', 'JJA')
	lat_son, lon_son, cru_son = import_grid(dict_var[var][1], domain, 'CRU', 'SON')

	lat_djf, lon_djf, cpc_djf = import_grid(dict_var[var][2], domain, 'CPC', 'DJF')
	lat_mam, lon_mam, cpc_mam = import_grid(dict_var[var][2], domain, 'CPC', 'MAM')
	lat_jja, lon_jja, cpc_jja = import_grid(dict_var[var][2], domain, 'CPC', 'JJA')
	lat_son, lon_son, cpc_son = import_grid(dict_var[var][2], domain, 'CPC', 'SON')

	lat_djf, lon_djf, era5_djf = import_grid(dict_var[var][4], domain, 'ERA5', 'DJF')
	lat_mam, lon_mam, era5_mam = import_grid(dict_var[var][4], domain, 'ERA5', 'MAM')
	lat_jja, lon_jja, era5_jja = import_grid(dict_var[var][4], domain, 'ERA5', 'JJA')
	lat_son, lon_son, era5_son = import_grid(dict_var[var][4], domain, 'ERA5', 'SON')
