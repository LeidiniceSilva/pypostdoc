...
sc = ax1.scatter(lon_, lat_, 12, inmet_idx_95, cmap=matplotlib.colors.ListedColormap(color), edgecolors='black', linewidth=0.5, marker='o', vmin=0, vmax=180) 
...
sc = ax2.scatter(lon_, lat_, 12, inmet_idx_99, cmap=matplotlib.colors.ListedColormap(color), edgecolors='black', linewidth=0.5, marker='o', vmin=0, vmax=180) 
...
name_out = 'pyplt_maps_precipitation_95-99th_CP-RCM_SAM-3km_2018-2021.png'
