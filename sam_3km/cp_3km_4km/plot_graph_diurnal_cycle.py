...
if var == 'pr':
	...
	cp_3km = import_cp_3km(var, 'SESA-3km', 'RegCM5', 'dc')
...
name_out = 'pyplt_graph_diurnal_cycle_{0}_CP-RegCM5_SAM-3km_2018-2021.png'.format(var)
