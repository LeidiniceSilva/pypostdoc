...
plt.plot(era5_pdf, marker='o', markersize=4, mfc='black', mec='black', alpha=0.70, linestyle='None', label='ERA5')
...
plt.plot(wsm5_pdf, marker='o', markersize=4, mfc='red', mec='red', alpha=0.70, linestyle='None', label='WSM5')
