...
plt_map = map.contourf(xx, yy, eobs_djf, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(a) EOBS DJF', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 2)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, noto_djf, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(b) NoTo DJF', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 3)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, wdm7_djf, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(c) WDM7 DJF', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 4)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, wsm7_djf, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(d) WSM7 DJF', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 5)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, wsm5_djf, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(e) WSM5 DJF', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 6)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, eobs_mam, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(f) EOBS MAM', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 7)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, noto_mam, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(g) NoTo MAM', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 8)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, wdm7_mam, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(h) WDM7 MAM', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 9)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, wsm7_mam, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(i) WSM7 MAM', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 10)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, wsm5_mam, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(j) WSM5 MAM', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 11)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, eobs_jja, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(k) EOBS JJA', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 12)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, noto_jja, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(l) NoTo JJA', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 13)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, wdm7_jja, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(m) WDM7 JJA', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 14)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, wsm7_jja, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(n) WSM7 JJA', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 15)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, wsm5_jja, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(o) WSM5 JJA', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 16)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, eobs_son, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(p) EOBS SON', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 17)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, noto_son, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(q) NoTo SON', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 18)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, wdm7_son, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(r) WDM7 SON', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 19)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, wsm7_son, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
plt.title(u'(s) WSM7 SON', loc='left', fontsize=font_size, fontweight='bold')

ax = fig.add_subplot(4, 5, 20)  
map, xx, yy = basemap(lat, lon)
plt_map = map.contourf(xx, yy, wsm5_son, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
