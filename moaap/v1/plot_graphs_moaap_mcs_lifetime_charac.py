...
def plot_domain_inset(ax, domain):
    ...
    if domain == 'CAR-4':
        inset_ax = ax.inset_axes([0.05, 0.5, 0.4, 0.5], projection=ccrs.PlateCarree())
    elif domain == 'CSAM-3':
        inset_ax = ax.inset_axes([0.05, 0.5, 0.4, 0.5], projection=ccrs.PlateCarree())
    else:
        inset_ax = ax.inset_axes([0.05, 0.5, 0.4, 0.5], projection=ccrs.PlateCarree())
...
size_mcs_car_era5, tot_mcs_car_era5, max_mcs_car_era5, hours = comp_lifetime_cycle(mcs_car_era5)
size_mcs_csam_era5, tot_mcs_csam_era5, max_mcs_csam_era5, hours = comp_lifetime_cycle(mcs_csam_era5)
size_mcs_eurr_era5, tot_mcs_eurr_era5, max_mcs_eurr_era5, hours = comp_lifetime_cycle(mcs_eurr_era5)

size_mcs_car_cpm, tot_mcs_car_cpm, max_mcs_car_cpm, hours = comp_lifetime_cycle(mcs_car_cpm)
size_mcs_csam_cpm, tot_mcs_csam_cpm, max_mcs_csam_cpm, hours = comp_lifetime_cycle(mcs_csam_cpm)
size_mcs_eurr_cpm, tot_mcs_eurr_cpm, max_mcs_eurr_cpm, hours = comp_lifetime_cycle(mcs_eurr_cpm)
...
width=0.35
xtick = [f'{int(h)}' for h in hours]

ax = fig.add_subplot(3, 3, 1)
ax.bar(hours - width/2, size_mcs_car_era5, width=width, color='red', alpha=0.75, edgecolor='red', label='ERA5')
ax.bar(hours + width/2, size_mcs_car_cpm, width=width, color='blue', alpha=0.75, edgecolor='blue', label='RegCM5')
...
plt.xticks(hours, xtick, fontsize=font_size)
ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)
plt.legend(loc=1, ncol=2, frameon=False, fontsize=font_size)

ax = fig.add_subplot(3, 3, 2)
ax.bar(hours - width/2, size_mcs_csam_era5, width=width, color='red', alpha=0.75, edgecolor='red', label='ERA5')
ax.bar(hours + width/2, size_mcs_csam_cpm, width=width, color='blue', alpha=0.75, edgecolor='blue', label='RegCM5')
...
ax.bar(hours - width/2, size_mcs_eurr_era5, width=width, color='red', alpha=0.75, edgecolor='red', label='ERA5')
ax.bar(hours + width/2, size_mcs_eurr_cpm, width=width, color='blue', alpha=0.75, edgecolor='blue', label='RegCM5')
...
ax.bar(hours - width/2, tot_mcs_car_era5, width=width, color='red', alpha=0.75, edgecolor='red', label='ERA5')
ax.bar(hours + width/2, tot_mcs_car_cpm, width=width, color='blue', alpha=0.75, edgecolor='blue', label='RegCM5')
...
ax.bar(hours - width/2, tot_mcs_csam_era5, width=width, color='red', alpha=0.75, edgecolor='red', label='ERA5')
ax.bar(hours + width/2, tot_mcs_csam_cpm, width=width, color='blue', alpha=0.75, edgecolor='blue', label='RegCM5')
...
ax.bar(hours - width/2, tot_mcs_eurr_era5, width=width, color='red', alpha=0.75, edgecolor='red', label='ERA5')
ax.bar(hours + width/2, tot_mcs_eurr_cpm, width=width, color='blue', alpha=0.75, edgecolor='blue', label='RegCM5')
...
ax.bar(hours - width/2, max_mcs_car_era5, width=width, color='red', alpha=0.75, edgecolor='red', label='ERA5')
ax.bar(hours + width/2, max_mcs_car_cpm, width=width, color='blue', alpha=0.75, edgecolor='blue', label='RegCM5')
plt.title('(g)', loc='left', fontsize=font_size, fontweight='bold')
plt.xlabel('MCSs lifetime (hours)', fontsize=font_size, fontweight='bold')
...
ax.bar(hours - width/2, max_mcs_csam_era5, width=width, color='red', alpha=0.75, edgecolor='red', label='ERA5')
ax.bar(hours + width/2, max_mcs_csam_cpm, width=width, color='blue', alpha=0.75, edgecolor='blue', label='RegCM5')
...
ax.bar(hours - width/2, max_mcs_eurr_era5, width=width, color='red', alpha=0.75, edgecolor='red', label='ERA5')
ax.bar(hours + width/2, max_mcs_eurr_cpm, width=width, color='blue', alpha=0.75, edgecolor='blue', label='RegCM5')
...
name_out = f'pyplt_graphs_moaap_mcs_lifetime_charac_hour_by_hour_5-20h_2000-2009.png'
