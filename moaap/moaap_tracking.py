...
data_vars = xr.open_dataset('/leonardo/home/userexternal/mdasilva/leonardo_work/MOAAP/CSAM-3/input/20000101-04_MOAAP-Input_24h.nc')

dT = 1 # time interval of input files (hr)
Mask = np.copy(data_vars['xlon']); Mask[:]=1 # tracking is applied globally
DataName = 'ERA5'
OutputFolder = '/leonardo/home/userexternal/mdasilva/leonardo_work/MOAAP/CSAM-3/output/'
...
data_moaap = xr.open_dataset('/leonardo/home/userexternal/mdasilva/leonardo_work/MOAAP/CSAM-3/output/20000101_ERA5_ObjectMasks__dt-1h_MOAAP-masks.nc')

# load MCS characteristics
import pickle
with open('/leonardo/home/userexternal/mdasilva/leonardo_work/MOAAP/CSAM-3/output/MCSs_200001__dt-1h_MOAAP-masks.pkl', 'rb') as f:
...
for tt in tqdm(range(len(time_datetime))):
    ...
    # Show the plot
    fig.savefig('/leonardo/home/userexternal/mdasilva/leonardo_work/MOAAP/CSAM-3/images/'+str(tt).zfill(3)+'_CausesOfExtreme_100_daily-extremes.jpg', bbox_inches='tight', dpi=100)
    plt.close()
...
make_gif("/leonardo/home/userexternal/mdasilva/leonardo_work/MOAAP/CSAM-3/images/")
...
fname = '/leonardo/home/userexternal/mdasilva/leonardo_work/MOAAP/CSAM-3/images/phenomenon.gif'
