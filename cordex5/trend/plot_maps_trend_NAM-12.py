...
def main():
    ...
    lat_rcm1, lon_rcm1, rcm1_data = import_regcm_dataset(var, 'ERA5_RegCM5')
    lat_rcm2, lon_rcm2, rcm2_data = import_regcm_dataset(var, 'ERA5_RegCM5')
    lat_rcm3, lon_rcm3, rcm3_data = import_regcm_dataset(var, 'ERA5_RegCM5')
