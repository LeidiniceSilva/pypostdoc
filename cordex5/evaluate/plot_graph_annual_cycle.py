...
def import_obs(param, dataset):
	...
	for i in range(0, 6):
		...
		arq  = xr.open_dataset('{0}/user/mdasilva/CORDEX/post_evaluate/obs/{1}_{2}_mon_2000-2009_lonlat.nc'.format(path, param, dataset))
		data = arq[param]
		var  = data.sel(lat=slice(yy-0.03,yy+0.03),lon=slice(xx-0.03,xx+0.03)).mean(('lat','lon'))
		time = var.sel(time=slice('2000-01-01','2009-12-31'))
		mean = time.groupby('time.month').mean('time')
		ts.append(mean.values)
...
def import_rcm(param, dataset):
	...
	for i in range(0, 6):
		...
		arq  = xr.open_dataset('{0}/user/mdasilva/CORDEX/post_evaluate/rcm/{1}_{2}_mon_2000-2005_lonlat.nc'.format(path, param, dataset))
		data = arq[param]
		var  = data.sel(lat=slice(yy-0.03,yy+0.03),lon=slice(xx-0.03,xx+0.03)).mean(('lat','lon'))
		time = var.sel(time=slice('2000-01-01','2005-12-31'))
		mean = time.groupby('time.month').mean('time')
		ts.append(mean.values)
...
ts_cru    = import_obs(dict_var[var][0], 'CSAM-3_CRU')
...
plt.plot(time, ts_cru[0],    linewidth=1., color='cyan',   markersize=2, marker='o', markerfacecolor='white', label='CRU')
plt.plot(time, ts_cpc[0],    linewidth=1., color='green',  markersize=2, marker='o', markerfacecolor='white', label='CPC')
plt.plot(time, ts_cmorph[0], linewidth=1., color='red',    markersize=2, marker='o', markerfacecolor='white', label='CMORPH')
plt.plot(time, ts_mswep[0],  linewidth=1., color='violet', markersize=2, marker='o', markerfacecolor='white', label='MSWEP')
...
plt.plot(time, ts_cru[1],    linewidth=1., color='cyan',   markersize=2, marker='o', markerfacecolor='white', label='CRU')
plt.plot(time, ts_cpc[1],    linewidth=1., color='green',  markersize=2, marker='o', markerfacecolor='white', label='CPC')
plt.plot(time, ts_cmorph[1], linewidth=1., color='red',    markersize=2, marker='o', markerfacecolor='white', label='CMORPH')
plt.plot(time, ts_mswep[1],  linewidth=1., color='violet', markersize=2, marker='o', markerfacecolor='white', label='MSWEP')
...
plt.plot(time, ts_cru[2],    linewidth=1., color='cyan',   markersize=2, marker='o', markerfacecolor='white', label='CRU')
plt.plot(time, ts_cpc[2],    linewidth=1., color='green',  markersize=2, marker='o', markerfacecolor='white', label='CPC')
plt.plot(time, ts_cmorph[2], linewidth=1., color='red',    markersize=2, marker='o', markerfacecolor='white', label='CMORPH')
plt.plot(time, ts_mswep[2],  linewidth=1., color='violet', markersize=2, marker='o', markerfacecolor='white', label='MSWEP')
...
plt.plot(time, ts_cru[3],    linewidth=1., color='cyan',   markersize=2, marker='o', markerfacecolor='white', label='CRU')
plt.plot(time, ts_cpc[3],    linewidth=1., color='green',  markersize=2, marker='o', markerfacecolor='white', label='CPC')
plt.plot(time, ts_cmorph[3], linewidth=1., color='red',    markersize=2, marker='o', markerfacecolor='white', label='CMORPH')
plt.plot(time, ts_mswep[3],  linewidth=1., color='violet', markersize=2, marker='o', markerfacecolor='white', label='MSWEP')
...
plt.plot(time, ts_cru[4],    linewidth=1., color='cyan',   markersize=2, marker='o', markerfacecolor='white', label='CRU')
plt.plot(time, ts_cpc[4],    linewidth=1., color='green',  markersize=2, marker='o', markerfacecolor='white', label='CPC')
plt.plot(time, ts_cmorph[4], linewidth=1., color='red',    markersize=2, marker='o', markerfacecolor='white', label='CMORPH')
plt.plot(time, ts_mswep[4],  linewidth=1., color='violet', markersize=2, marker='o', markerfacecolor='white', label='MSWEP')
...
plt.plot(time, ts_cru[5],    linewidth=1., color='cyan',   markersize=2, marker='o', markerfacecolor='white', label='CRU')
plt.plot(time, ts_cpc[5],    linewidth=1., color='green',  markersize=2, marker='o', markerfacecolor='white', label='CPC')
plt.plot(time, ts_cmorph[5], linewidth=1., color='red',    markersize=2, marker='o', markerfacecolor='white', label='CMORPH')
plt.plot(time, ts_mswep[5],  linewidth=1., color='violet', markersize=2, marker='o', markerfacecolor='white', label='MSWEP')
