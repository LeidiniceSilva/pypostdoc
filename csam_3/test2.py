...
# Plot figure   
#dict_plot = {'p99': ['Daily p99 (mm d$^-$$^1$)', np.arange(-70, 80, 10), cm.BrBG]}
dict_plot = {'p99': ['Hourly p99 (mm h$^-$$^1$)', np.arange(-24, 26, 2), cm.BrBG]}
...
plt_map = map.contourf(xx, yy, mbe_regcm5_era5, levels=dict_plot[var][1], cmap=dict_plot[var][2], extend='neither') 
